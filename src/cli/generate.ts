...
const validateEncoding = (encoding: string): string => {
  ...
  throw Error(`Invalid encoding: ${encoding}. Valid options are: ${validEncodings}`);
};
...
const validatePattern = (patternName: string): string => {
  ...
  throw Error(`Invalid pattern: ${patternName}. Valid options are: ${validPatternNames}`);
};
...
const validateType = (typeName: string): string => {
  ...
  throw Error(`Invalid untyped: ${typeName}. Valid options are: ${validTypeNames}`);
};
